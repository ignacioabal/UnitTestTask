#undef UNITTESTTASK_API
#undef UNITTESTTASK_VTABLE
...
#define UE_PROJECT_NAME UnitTestTask
...
#define UNITTESTTASK_VTABLE DLLEXPORT_VTABLE
#define UNITTESTTASK_API DLLEXPORT
